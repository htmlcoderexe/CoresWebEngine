...
<script>
    ...
    */
    ...
    let cal = document.querySelector('.cal-days');
    let last_month_days = new Date({%year%}, {%month%}-1, 0).getDate();
    ...
    let this_month_days = new Date({%year%}, {%month%}, 0).getDate();
    // current month
    ...
    let currentmonth = (thisyear=={%year%} && thismonth == {%month%}-1);
    ...
    last_day_of_week = (first_day_of_week + this_month_days-1) % 7;
    ...
    // weeks
    let weeks = document.querySelector('.cal-weeks');
